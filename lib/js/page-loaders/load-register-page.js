                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <form id="register-form">
                            ...
                            <div class="acknowledge-checkbox">
                                <label>By creating an account you're agreeing to our <strong><a onclick="openExternalWebsite('https://clippsly.app/terms-of-use')" href="https://clippsly.app/terms-of-use">Terms of Use</a></strong>.</label>
                            </div>
...
function showRegisterFailedMessage(errorMessage = 'An error occurred during the registration process. Please try again.') {
    document.querySelector('.container').innerHTML = `
        <div class="container mt-5">
...
function setupRegisterEventHandlers(queryParams) {
    $(document).ready(function() {
        $('#register-form').on('submit', function(e) {
            ...
            $.ajax({
                url: 'https://api.clippsly.app/endpoints/authentication/account-sign-up',
                method: 'POST',
                contentType: 'application/json',
                data: JSON.stringify({
                    username: username,
