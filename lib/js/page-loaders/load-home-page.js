function loadHomePage() {
    ...
    container.innerHTML = `
        ...
        <h2>Latest Videos</h2>
        <div id="latest-videos" class="track-list"></div>
...
function fetchTracks() {
    ...
    fetch('https://api.clippsly.app/endpoints/functions/home-page', {
        method: 'GET',
        headers: {
        ...
        .then(data => {
            ...
            latestVideosContainer.innerHTML = generateVideoHTML(latestVideos);
            ...
            <div class="track">
                <div class="cover">
                    <a href="/track/${track.ID}" onclick="visitTrackPage(${track.ID})">
                        <img src="${track.ArtCover ? track.ArtCover : 'https://cdn.clippsly.app/brand_assets/icons/default-artist.png'}" 
                            alt="Track Cover" 
                ...
                <div class="details">
                    <a href="/users/${track.releaseAuthor.authorUsername}" onclick="visitUserProfile('${track.releaseAuthor.authorUsername}')">
                        <img src="${track.releaseAuthor.authorAvatar ? track.releaseAuthor.authorAvatar : 'https://cdn.clippsly.app/brand_assets/icons/default-artist.png'}" 
                            alt="Profile Picture" 
                            class="profile-pic" 
                            onerror="this.onerror=null; this.src='https://cdn.clippsly.app/brand_assets/icons/default-artist.png';">
                    </a>
                    <div class="text">
                        <a href="/track/${track.ID}" onclick="visitTrackPage(${track.ID})"><p class="track-title">${truncatedTitle}</p></a>
...
function generateVideoHTML(videos) {
    return videos.map(video => {
        ...
        return `
            <div class="track">
                <div class="cover">
                    <a href="/video/${video.ID}" onclick="visitVideoPage(${video.ID})">
                        <img src="${video.Thumbnail ? video.Thumbnail : 'https://cdn.clippsly.app/brand_assets/icons/default-artist.png'}" 
                            alt="Track Cover" 
                            onerror="this.onerror=null; this.src='https://cdn.clippsly.app/brand_assets/icons/default-artist.png';">
                    </a>
                </div>
                <div class="details">
                    <a href="/users/${video.releaseAuthor.authorUsername}" onclick="visitUserProfile('${video.releaseAuthor.authorUsername}')">
                        <img src="${video.releaseAuthor.authorAvatar ? video.releaseAuthor.authorAvatar : 'https://cdn.clippsly.app/brand_assets/icons/default-artist.png'}" 
                            alt="Profile Picture" 
                            class="profile-pic" 
                            onerror="this.onerror=null; this.src='https://cdn.clippsly.app/brand_assets/icons/default-artist.png';">
                    </a>
                    <div class="text">
                        <a href="/video/${video.ID}" onclick="visitVideoPage(${video.ID})"><p class="track-title">${truncatedTitle}</p></a>
                        <a href="/users/${video.releaseAuthor.authorUsername}" onclick="visitUserProfile('${video.releaseAuthor.authorUsername}')"><p class="track-artist">${truncatedArtist} ${verifiedBadge}</p></a>
                    </div>
                </div>
            </div>
        `;
