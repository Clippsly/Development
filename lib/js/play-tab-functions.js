...
function playRequestedTrack(trackId) {
    const bearerToken = getCookie('CLIPSESSIONTOKEN');
    fetch(`https://api.clippsly.app/endpoints/data/track?id=${trackId}`, {
        ...
        .then(trackData => {
            ...
            if (!artCover || !trackTitleEl || !artistNameEl || !totalTimeEl || !currentTimeEl || !progressSlider || !playPauseBtn || !volumeSlider) {
            ...
            audio.play();
            isPlaying = true;
            playPauseBtn.src = 'https://cdn.clippsly.app/brand_assets/controls/pause.png';
...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    document.querySelector('#play-pause-btn').addEventListener('click', function() {
        if (isPlaying) {
            audio.pause();
            playPauseBtn.src = 'https://cdn.clippsly.app/brand_assets/controls/play.png';
        } else {
            audio.play();
            playPauseBtn.src = 'https://cdn.clippsly.app/brand_assets/controls/pause.png';
        }
