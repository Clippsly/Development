...
`,Zd=`
    ...
    <div class="middle-float" data-controller="balance">
        ...
        <fluent-button shape="circular" icon-only>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`.withBehaviors(Ct(N`
  ...
  :host(${Lt}:is(:hover, :hover:active)) {
    border-color: transparent;
    color: ${en};
  }

  :host(${Lt}:hover:active) {
    background-color: ${zf};
  }

  :host(${Lt}:focus-visible) {
    border-color: ${en};
...
`,wc=N`
  ...
  :host(${Lt}:is(:disabled, [disabled-focusable])),
  :host(${Lt}:is(:disabled, [disabled-focusable]):is(:hover, :hover:active)) {
    border-color: transparent;
  }
...
`.withBehaviors(Ct(N`
    ...
    :host(${Lt}:not(:is(:hover, :focus-visible))) {
