...
`.withBehaviors(Ct(N`
  ...
  :host(${Ft}:is(:hover, :hover:active)) {
    border-color: transparent;
    color: ${en};
  }

  :host(${Ft}:hover:active) {
    background-color: ${zf};
  }

  :host(${Ft}:focus-visible) {
    border-color: ${en};
...
`,wc=N`
  ...
  :host(${Ft}:is(:disabled, [disabled-focusable])),
  :host(${Ft}:is(:disabled, [disabled-focusable]):is(:hover, :hover:active)) {
    border-color: transparent;
  }
...
`.withBehaviors(Ct(N`
    ...
    :host(${Ft}:not(:is(:hover, :focus-visible))) {
