...
`,qb=`
    <div class="trackpage" data-controller="track" aria-hidden="true">
        <div>
            ...
            <a class="sr-only skip" href="#moreFromAuthor">Skip past comments</a>
            <div class="inline-comments-section-container">
                ...
                <div class="inline-comments-section" data-track-target="inlineCommentsSection">
                    <fluent-spinner size="huge"></fluent-spinner>
                </div>
            </div>
            <fluent-button
            ...
            <fluent-dialog data-track-target="commentsDialog">
                <fluent-dialog-body>
                    <div class="inline-comments-section" data-track-target="commentsDialogContent"></div>
                    <div slot="title">Comments</div>
                </fluent-dialog-body>
            </fluent-dialog>
        </div>
        <div class="more-from-author" id="moreFromAuthor">
...
`,Q1=ut.compose({name:`${L.prefix}-avatar`,template:W1,styles:G1}),cl={filled:"filled",ghost:"ghost",outline:"outline",tint:"tint"},ul={brand:"brand",danger:"danger",important:"important",informative:"informative",severe:"severe",subtle:"subtle",success:"success",warning:"warning"},X1={circular:"circular",rounded:"rounded",square:"square"},Z1={tiny:"tiny",extraSmall:"extra-small",small:"small",medium:"medium",large:"large",extraLarge:"extra-large"};class Pn extends pe{constructor(){super(...arguments),this.elementInternals=this.attachInternals(),this.appearance=cl.filled,this.color=ul.brand}appearanceChanged(e,t){j(this.elementInternals,e,t,cl)}colorChanged(e,t){j(this.elementInternals,e,t,ul)}shapeChanged(e,t){j(this.elementInternals,e,t,X1)}sizeChanged(e,t){j(this.elementInternals,e,t,Z1)}}m([b],Pn.prototype,"appearance",void 0);m([b],Pn.prototype,"color",void 0);m([b],Pn.prototype,"shape",void 0);m([b],Pn.prototype,"size",void 0);zn(Pn,Ln);function Y1(n={}){return R`
    ${Mn(n)}
